...
import com.uxnux.auth.properties.CryptoProperties;
...
public class CryptoUtils {
    ...
    public static String encryptAES(String src) {
        ...
        try {
            byte[] aesBytes =  encrypt(src, CryptoProperties.aesTransformation, CryptoProperties.aesAlgorithm,
                    CryptoProperties.iv.getBytes(),
                    CryptoProperties.aesKey.getBytes());
    ...
    public static String decryptAES(String src) {
        ...
        try {
            byte[] aesBytes =  decrypt(src, CryptoProperties.aesTransformation, CryptoProperties.aesAlgorithm,
                    CryptoProperties.iv.getBytes(),
                    CryptoProperties.aesKey.getBytes());
